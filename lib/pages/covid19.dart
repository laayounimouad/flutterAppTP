                ...
                children: [
                  Card(
                      child: ListTile(
                        ...
                        subtitle: Column(
                          children: [
                            Text("Total confirmed : ${general[0]["TotalConfirmed"].toString()}"),
                            Text("Total deaths : ${general[0]["TotalDeaths"].toString()}"),
                          ],
                        )
                        ),
                  ),
                  Expanded(child:
                    ListView.builder(itemCount: stats==null?0:stats[0].length,itemBuilder: (context, index) {
